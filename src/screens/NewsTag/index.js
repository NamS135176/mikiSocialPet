          ...
          <Box backgroundColor="white">
            {postTag.postTag.length == 0 ? (
              <Center>
                ...
                >
                  Chưa có bài viết nào sử dụng thẻ này. Hãy là người đầu tiên
                  nhé!
                </Text>
              </Center>
            ) : (
              <Box>
                {postTag.postTag.map((item, index) => {
                  return (
                    <Box key={index} marginBottom={5}>
                      ...
                      >
                        ...
                        >
                          <Flex flexDirection="row" alignItems="center">
                            ...
                            <Box marginLeft={3}>
                              ...
                              <Text
                                style={{ fontFamily: 'Nunito', fontSize: 15 }}
                              >
                        ...
                        >
                          ...
                          <Center marginTop={5} paddingBottom={30}>
                            <Text
                              style={{ fontFamily: 'NunitoSemi', fontSize: 20 }}
                            >
                              ...
                              {item.liked.filter((item) => {
                                ...
                                <Pressable
                                  onPress={async () => {
                                    ...
                                    const i =
                                      listPost[index].liked.indexOf(thisLike);
