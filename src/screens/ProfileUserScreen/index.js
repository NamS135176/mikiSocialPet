...
export default function ProfileUserScreen({ route, navigation }) {
    ...
    useEffect(() => {
        ...
        const promise1 = api.post('get-account', {
            account: account
        }, {
            headers: {
        ...
        const promise2 = api.get(`post-api/get-post-list-by-account/${account}`)
        Promise.all([promise1, promise2])
            .then(res => {
                if(res[0].data.coverImage){
                    setUser(res[0].data)
                    setListPost(res[1].data)
                    setIsLoading(false)
                }
                else{
                    Alert.alert(
        ...
        //         // console.log(JSON.parse(result).followMe);
        //         // console.log(JSON.parse(result));
        //         fetch(`http://obnd.me/post-api/get-post-list-by-account/${account}`, {
        //             method: "GET",
        //             headers: {
        //                 "Content-Type": "application/json"
        //             }
        ...
        return (
            <SafeAreaView>
                <ScrollView backgroundColor='white'>
                    {
                        isLoading ? <Box backgroundColor='white' position='relative'>
                            <SkeletonContent
                            ...
                            <Center marginTop={-75} zIndex={3} >
                                <SkeletonContent
                                    ...
                                    isLoading={true}
                                >
                                    <Text style={{ width: 150, height: 150, borderRadius: 75, borderWidth: 10, borderColor: 'white' }}> </Text>
                                </SkeletonContent>
                            </Center>
                            ...
                            <SkeletonContent
                                ...
                                isLoading={true}
                            >
                                <Text style={{ width: 200, height: 60, marginTop: 15, marginLeft: 15 }}> </Text>
                            </SkeletonContent>
                            <SkeletonContent
                                containerStyle={{ width: '100%' }}
                                isLoading={true}
                            ...
                            <Box backgroundColor='white' position='relative'>
                                ...
                                <Center paddingX={10} paddingTop={5} >
                                    <Text style={{ textAlign: 'center' }}>{user.owner.description}</Text>
                                </Center>
                                <Flex marginTop={3} flexDirection='row' justifyContent='center'>
                                    {
                                    ...
                                    status == 1 ? <Box marginTop={3}>
                                        ...
                                        </Flex>
                                        {
                                            isImg == 1 ? <Box width='100%'>
                                                {listPost.length == 0 ? <Text style={{ fontFamily: 'Nunito', padding: 25, fontSize: 20, textAlign: 'center' }}>
                                        ...
                                        }
                                        {
                                            isImg == 2 ? <Center paddingBottom={5} marginTop={5} width='100%'>
                                                <Flex alignItems='center' flexDirection='row' width='90%' paddingX={5} paddingY={3} borderWidth={1} borderColor='black' borderRadius={10}>
                                                    ...
                                                    <Text flex={1} style={{ textAlign: 'center' }}>{user.displayName}</Text>
                                                ...
                                                <Flex marginTop={3} width='90%' flexDirection='row' justifyContent='space-around'>
                                                    ...
                                                    <Flex alignItems='center' flex={1} marginLeft={1} flexDirection='row' paddingX={5} paddingY={3} borderWidth={1} borderColor='black' borderRadius={10}>
                                                        ...
                                                        <Text flex={1} style={{ textAlign: 'center' }}>{user.birthDay}</Text>
                                                ...
                                                <Flex marginTop={3} width='90%' flexDirection='row' justifyContent='space-around'>
                                                    <Flex alignItems='center' flex={2} marginRight={1} flexDirection='row' paddingX={5} paddingY={3} borderWidth={1} borderColor='black' borderRadius={10}>
                                                        ...
                                                        <Text flex={1} style={{ textAlign: 'center' }}>{user.typePet}</Text>
                                                ...
                                                <Flex marginTop={3} alignItems='center' flexDirection='row' width='90%' paddingX={5} paddingY={3} borderWidth={1} borderColor='black' borderRadius={10}>
                                                    <Ionicons size={30} name="people-circle" color='black'></Ionicons>
                                                    <Text flex={1} style={{ textAlign: 'center' }}>{user.owner.name}</Text>
                                        ...
                                        <Box paddingBottom={5}>
                                            ...
                                            <Flex marginX={5} borderBottomWidth={1} borderColor='#ddd' paddingY={3} alignItems='center' flexDirection='row' justifyContent='space-between' >
                                                ...
                                                <Box flex={1} paddingLeft={5}>
                                                    <Text style={{ fontSize: 20, fontFamily: 'NunitoExBold', textAlign: 'right' }}>{user.owner.name}</Text>
                                                </Box>
                                            </Flex>
                                            <Flex marginX={5} borderBottomWidth={1} borderColor='#ddd' paddingY={3} alignItems='center' flexDirection='row' justifyContent='space-between' >
                                                <Flex flexDirection='row' alignItems='center'>
                                                ...
                                                <Box flex={1} paddingLeft={5}>
                                                    <Text style={{ fontSize: 20, fontFamily: 'NunitoExBold', textAlign: 'right' }}>{user.owner.birthDay}</Text>
                                                </Box>
                                            </Flex>
                                            <Flex marginX={5} borderBottomWidth={1} borderColor='#ddd' paddingY={3} alignItems='center' flexDirection='row' justifyContent='space-between' >
                                                <Flex flexDirection='row' alignItems='center'>
                                                ...
                                                <Box flex={1} paddingLeft={5}>
                                                    {
                                                        user.sex ? <Text style={{ fontSize: 20, fontFamily: 'NunitoExBold', textAlign: 'right' }}>Nam</Text> : <Text style={{ fontSize: 20, fontFamily: 'NunitoExBold', textAlign: 'right' }}>Nữ</Text>
                                                    }
                                                </Box>
                                            </Flex>
                                            <Flex marginX={5} borderBottomWidth={1} borderColor='#ddd' paddingY={3} alignItems='center' flexDirection='row' justifyContent='space-between' >
                                                ...
                                                <Box flex={1} paddingLeft={5}>
                                                    <Text style={{ fontSize: 20, fontFamily: 'NunitoExBold', textAlign: 'right' }}>{user.owner.hobby}</Text>
                                                </Box>
                                            </Flex>
                                            <Flex marginX={5} borderBottomWidth={1} borderColor='#ddd' paddingY={3} alignItems='center' flexDirection='row' justifyContent='space-between' >
                                                <Flex flexDirection='row' alignItems='center'>
                                                ...
                                                <Box flex={1} paddingLeft={5}>
                                                    <Text style={{ fontSize: 20, fontFamily: 'NunitoExBold', textAlign: 'right' }}>{user.displayName}</Text>
                                                </Box>
                                            </Flex>
                                        </Box>
