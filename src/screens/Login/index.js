    ...
    if (!fontsLoaded) {
        ...
        return (
            <View style={{ flex: 1 }}>
                ...
                <Image style={{ width: "100%", height: '100%', position: 'absolute', top: 0, left: 0 }} source={require('../../../src/images/Login/bg_login.png')}></Image>
                <KeyboardAvoidingView behavior="position">
                    <Image style={{ width: "25%", height: 100, alignSelf: 'center', marginTop: 40 }} source={require('../../../src/images/Login/logo.png')}></Image>
                    <Text style={{
                        color: "#4F292C",
                        fontSize: 30,
                        textAlign: "center",
                    ...
                    <Text style={{
                        ...
                        marginTop: -15
                    }}>Tận hưởng thế giới thú cưng của bạn!</Text>
                    <View style={{ marginTop: 145 }}>
                        <View style={{ height: 60, zIndex: 10 }}>
                            <View style={{ paddingHorizontal: 20, backgroundColor: "#e1e1e1", alignSelf: "center", borderRadius: 50, width: "80%", flex: 1, flexDirection: 'row', alignItems: 'center' }}>
                                ...
                                <TextInput onChangeText={handleChangeAccountName} style={{ marginLeft: 20, width: "100%" }} placeholder="Nhập tài khoản"></TextInput>
                            </View>
                        </View>
                        <View style={{ height: 60, marginTop: 20 }}>
                            <View style={{ paddingHorizontal: 20, backgroundColor: "#e1e1e1", alignSelf: "center", borderRadius: 50, width: "80%", flex: 1, flexDirection: 'row', alignItems: 'center' }}>
                                <MaterialIcon name='lock' size={30} color="#ff9a7b" />
                                <TextInput onChangeText={handleChangePass} secureTextEntry={true} style={{ marginLeft: 20, width: "100%" }} placeholder="Nhập tài khoản"></TextInput>
                            </View>
                        </View>
                    </View>
                    <View style={{ width: "90%", marginTop: 10 }}>
                        <Text onPress={handleToForgotPass} style={{ textAlign: 'right', color: '#7B7B7B' }}>Quên mật khẩu?</Text>
                    </View>
                    <View style={{ width: "50%", alignSelf: 'center', backgroundColor: '#ff9a7b', height: 60, borderRadius: 50, marginTop: 10 }}>
                        <View style={{ flex: 1, alignItems: 'center', flexDirection: 'row', justifyContent: 'center' }}>
                            <Text onPress={handleSignIn} style={{ color: 'white', fontSize: 25 }}>Bắt Đầu</Text>
                        </View>
                    </View>
                    <View style={{ marginTop: 10 }}>
                        <Text style={{ textAlign: 'center', color: '#7B7B7B' }}>Nếu chưa có tài khoản hãy <Text onPress={handleToSignUp} style={{ color: '#FFA788', textDecorationLine: 'underline' }}>Đăng ký</Text></Text>
                    </View>
                    <View style={{ marginTop: 0 }}></View>
                </KeyboardAvoidingView>
                <View style={{ marginTop: 100 }}>
                    <View style={{ flex: 1, justifyContent: 'space-around', flexDirection: 'row' }}>
                        <View style={{ width: "40%", alignSelf: 'center', borderColor: '#597CC4', borderWidth: 1, height: 60, borderRadius: 50, marginTop: 10 }}>
                        ...
                        <View style={{ width: "40%", alignSelf: 'center', borderColor: '#DC4E41', borderWidth: 1, height: 60, borderRadius: 50, marginTop: 10 }}>
                            <View style={{ flex: 1, alignItems: 'center', flexDirection: 'row', justifyContent: 'space-evenly' }}>
                                <Image style={{ width: 28, height: 28 }} source={require('../../../src/images/Login/ic_google.png')}></Image>
