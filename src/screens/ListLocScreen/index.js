                  ...
                  >
                    <Flex flex={1} flexDirection="row">
                      <Box flex={1} paddingY={6} paddingX={5}>
                        ...
                        <Text
                          style={{ fontFamily: 'NunitoSemi', color: 'white' }}
                        >
                          {item.address}
                        </Text>
                      </Box>
                      ...
                      >
                        <Center>
                          <Image
                            alt="logo"
                            source={require('../../images/Utilities/ic_location_pet_shop.png')}
                            width={30}
                            height={38}
                          ></Image>
                        </Center>
                    ...
                    <Flex flex={1} flexDirection="row">
                      ...
                      >
                        <Center>
                          <Image
                            alt="logo"
                            source={require('../../images/Utilities/ic_location_pet_hospital.png')}
                            width={30}
                            height={38}
                          ></Image>
                        </Center>
