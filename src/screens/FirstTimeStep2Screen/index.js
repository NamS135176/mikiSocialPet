...
export default function FirstTimeStep2Screen({ route, navigation }) {
  const { petInfo, token, username, time } = route.params;
    ...
    <View style={{ flex: 1 }}>
      ...
      <KeyboardAvoidingView behavior="position">
        <View style={{ height: 60, zIndex: 10, marginTop: 150 }}>
          ...
          >
            <TextInput
              onChangeText={handleChangeOwnerName}
        ...
        <View style={{ marginTop: 20 }}>
          <View style={{ height: 60, zIndex: 10 }}>
            ...
            >
              <Text style={{ marginLeft: 20, width: '40%', color: '#7b7b7b' }}>
                Ngày sinh
              </Text>
              <View
                style={{
        ...
        <View style={{ height: 60, zIndex: 10, marginTop: 20 }}>
          ...
          >
            <TextInput
              onChangeText={handleChangeOwnerDes}
              style={{ marginLeft: 20, width: '80%' }}
              placeholder="Một vài từ mô tả bản thân..."
            ></TextInput>
