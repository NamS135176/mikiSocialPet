    ...
    if (!fontsLoaded) {
        ...
        return (
            <Box flex={1} backgroundColor='white' padding={30}>
                ...
                <Box overflow='hidden' width='100%' height='25%' marginY={8} backgroundColor='#ffa788' borderRadius={20}>
                ...
                <Box width='100%' height='27%' marginBottom={8}>
                    <Flex flex={1} flexDirection='row'>
                        <Box overflow='hidden' flex={1} backgroundColor='#fea7a7' marginRight={3} borderRadius={20}>
                        ...
                        <Box flex={1} overflow='hidden' backgroundColor='#99d2ff' marginLeft={3} borderRadius={20}>
                            <Flex width='100%' height='40%' flexDirection='row' justifyContent='space-between'>
                                <Center flex={1}>
                ...
                <Box width='100%' height='27%' >
                    <Flex flex={1} flexDirection='row'>
                        <Pressable flex={1} marginRight={3} onPress={() => {navigation.navigate('Maps')}}>
                        <Box overflow='hidden' flex={1} backgroundColor='#d1a9ff' borderRadius={20}>
                            <Flex width='100%' height='40%' flexDirection='row' justifyContent='space-between'>
                                <Center flex={1}>
                        ...
                        <Box overflow='hidden' flex={1} backgroundColor='#48d699' borderRadius={20}>
                            <Flex width='100%' height='40%' flexDirection='row' justifyContent='space-between'>
                                <Center flex={1}>
