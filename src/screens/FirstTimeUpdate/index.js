...
const cats = [
  ...
  { label: 'ALD' },
  { label: 'Scotish Fold' },
  { label: 'Scotish Straight' },
  { label: 'Golden' },
  { label: 'Munchkin' },
  { label: 'Sphynx' },
];
export default function FirstTimeUpdateScreen({ route, navigation }) {
    ...
    if (displayName == '') {
      ...
      if (isDogSelect) {
        if (typeDog == 'chọn loại') {
          ...
          navigation.navigate('FirstTimeStep2', {
            petInfo: {
        ...
        <View style={{ flex: 1 }}>
          ...
          >
            <PetSelector
              ...
              isDog={true}
              petType={typeDog}
              changeStatus={setSelectDog}
              openDogModal={openDogPick}
            />
            <PetSelector
              isSelect={!isDogSelect}
              isDog={false}
          ...
          <View style={{ marginTop: 20 }}>
            <View style={{ height: 60, zIndex: 10 }}>
              ...
              >
                ...
                ></TextInput>
                <Image
                  source={require('../../images/SignUp/ic_paw.png')}
          ...
          <View style={{ marginTop: 20 }}>
            <View style={{ height: 60, zIndex: 10 }}>
              ...
              >
                <Text
                  style={{ marginLeft: 20, width: '40%', color: '#7b7b7b' }}
                >
                  Giới tính
                </Text>
                {sex ? (
                  ...
                  >
                    ...
                    >
                      <Ionicons name="male" size={15} color="white" />
                    </View>
                    <Pressable onPress={() => setSex(!sex)}>
                      ...
                      >
                        <Ionicons name="female" size={15} color="gray" />
                      </View>
                    </Pressable>
                  </View>
                ) : (
                  ...
                  >
                    <Pressable onPress={() => setSex(!sex)}>
                      ...
                      >
                        <Ionicons name="male" size={15} color="gray" />
                      </View>
                    </Pressable>
                    <View
                      style={{
                    ...
                    >
                      <Ionicons name="female" size={15} color="white" />
                    </View>
                  </View>
                )}
              </View>
